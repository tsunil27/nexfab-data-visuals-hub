...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-black via-purple-950 to-black">
      ...
      <section id="spline-demo" className="py-20 bg-gradient-to-br from-black/80 to-purple-950/60 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-purple-100 mb-6">Interactive 3D Experience</h3>
            <p className="text-xl text-purple-300 max-w-4xl mx-auto">
              Experience the future of web interfaces with our cutting-edge 3D integration technology.
            </p>
          </div>
